...
public class G08HM3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //tempo del k-center
         ...
         ArrayList<Vector> centri = kcenter(point,10);
  ...
  public static ArrayList<Vector> kcenter (ArrayList<Vector> P ,int k){ //O( |P| * k )

    ArrayList<Vector> centers = new ArrayList<Vector> ();
    Vector max= Vectors.zeros(1);  //mi salvo il quello che sta a distanza massima
    ArrayList<Double> dist = new ArrayList<Double> (); //distanza massima
    double distanza=0.0;
    double temp=0.0;
    boolean primo = true;
